...
static String Usertype = "Student";//Since this is only for students the user type is already set to student
    /**
     * Creates new form StudentMainMenuUI
     * @param studID
     */
    public StudentMainMenuUI(String studID) {
        initComponents();
        StudentID = studID;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Main Menu (Student Mode)");

        btnViewMarks.setText("View Your Marks");
        ...
        btnInfoUpdate.setText("Update your Username or Password");
    ...
    private void btnViewMarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewMarksActionPerformed
       MarkViewerUI MVUI = new MarkViewerUI();
       MVUI.setVisible(true);
       this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentMainMenuUI(StudentID).setVisible(true);
            }
        });
    }
